...
move_specific_angle(stage_angles{1}, pi/2, 'C', start_z0, z0, 1, 10);
move_specific_angle(stage_angles{1}, pi/2, 'D', start_z0, z0, 1, 10);
move_specific_angle(stage_angles{1}, pi/2, 'E', start_z0, z0, 1, 10);
