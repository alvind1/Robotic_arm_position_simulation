...
get_ax_dim();
global num_nodes node_it arms_lengths closest_to_target_node_it;
...
plot_board();
inter_coord = gen_tree_angles(nodes, closest_to_target_nodes, [end_angles('C'), end_angles('D'), end_angles('E'), end_angles('T'), end_z0]);
